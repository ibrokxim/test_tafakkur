...
Это реализация тестового задания для PHP-разработчика, представляющая собой RESTful API для управления продуктами и категориями. Проект построен на фреймворке **Laravel 10** и полностью контейнеризирован с помощью **Docker**.
